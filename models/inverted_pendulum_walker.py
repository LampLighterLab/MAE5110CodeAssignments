...
def ankle_torque_guard(state, params):
    ...
    return True#np.linalg.norm(state) < 1  # placeholder
...
def update_ankle_torque(state, params):
    ...
    pos_control = -angle * 10  # TODO: update these controller gains with real numbers
    ...
    params["ankle_torque"] = max(
        -0.1 * params["mass"] * params["length"],
        min(ankle_torque, 0.05 * params["mass"] * params["length"]),
    )
...
def dynamics(t, state, params):
    ...
    ankle_torque = max(-0.1 * params["mass"] * params["length"], min(params["ankle_torque"], 0.05 * params["mass"] * params["length"]))
